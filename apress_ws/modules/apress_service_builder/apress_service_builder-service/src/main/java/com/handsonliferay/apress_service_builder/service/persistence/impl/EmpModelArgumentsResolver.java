...
@Component(
	immediate = true,
	service = {EmpModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class EmpModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			if (finderPath.isBaseModelResult() &&
				(EmpPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION ==
	...
	static {
		...
		orderByColumnsBitmask |= EmpModelImpl.getColumnBitmask("projectId");
