...
import com.handsonliferay.apress_service_builder.exception.NoSuchbookException;
import com.handsonliferay.apress_service_builder.model.book;
import com.handsonliferay.apress_service_builder.model.bookTable;
import com.handsonliferay.apress_service_builder.model.impl.bookImpl;
import com.handsonliferay.apress_service_builder.model.impl.bookModelImpl;
import com.handsonliferay.apress_service_builder.service.persistence.bookPersistence;
import com.handsonliferay.apress_service_builder.service.persistence.bookUtil;
...
public class bookPersistenceImpl
	...
	/**
	 * Returns all the books where isCoding = &#63;.
	 *
	 * @param isCoding the is coding
	 * @return the matching books
	 */
	@Override
	public List<book> findByIsCoding(boolean isCoding) {
		return findByIsCoding(
			isCoding, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the books where isCoding = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>bookModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<book> findByIsCoding(boolean isCoding, int start, int end) {
		return findByIsCoding(isCoding, start, end, null);
	}

	/**
	 * Returns an ordered range of all the books where isCoding = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>bookModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<book> findByIsCoding(
	...
	/**
	 * Returns the first book in the ordered set where isCoding = &#63;.
	 *
	 * @param isCoding the is coding
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching book
	 ...
	 */
	@Override
	public book findByIsCoding_First(
			boolean isCoding, OrderByComparator<book> orderByComparator)
		throws NoSuchbookException {

		book book = fetchByIsCoding_First(isCoding, orderByComparator);
	 ...
	 */
	@Override
	public book fetchByIsCoding_First(
		boolean isCoding, OrderByComparator<book> orderByComparator) {

		List<book> list = findByIsCoding(isCoding, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last book in the ordered set where isCoding = &#63;.
	 *
	 * @param isCoding the is coding
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching book
	 ...
	 */
	@Override
	public book findByIsCoding_Last(
			boolean isCoding, OrderByComparator<book> orderByComparator)
		throws NoSuchbookException {

		book book = fetchByIsCoding_Last(isCoding, orderByComparator);
	 ...
	 */
	@Override
	public book fetchByIsCoding_Last(
		boolean isCoding, OrderByComparator<book> orderByComparator) {
	...
	/**
	 * Returns the books before and after the current book in the ordered set where isCoding = &#63;.
	 *
	 * @param bookId the primary key of the current book
	 * @param isCoding the is coding
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public book[] findByIsCoding_PrevAndNext(
		...
		try {
			...
			array[0] = getByIsCoding_PrevAndNext(
				session, book, isCoding, orderByComparator, true);

			array[1] = book;

			array[2] = getByIsCoding_PrevAndNext(
				session, book, isCoding, orderByComparator, false);
	...
	protected book getByIsCoding_PrevAndNext(
		Session session, book book, boolean isCoding,
		OrderByComparator<book> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the books where isCoding = &#63; from the database.
	 *
	 * @param isCoding the is coding
	 */
	@Override
	...
	/**
	 * Returns the number of books where isCoding = &#63;.
	 *
	 * @param isCoding the is coding
	 * @return the number of matching books
	 */
