...
public interface EmpPersistence extends BasePersistence<Emp> {
	 ...
	 * @return the matching emp, or <code>null</code> if a matching emp could not be found
	 */
	public Emp fetchByUUID_G(String uuid, long groupId, boolean useFinderCache);
	 ...
	 * @return the matching emps
	 */
	public java.util.List<Emp> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching emps
	 */
	public java.util.List<Emp> findByUuid_C(
	 ...
	 * @return the matching emps
	 */
	public java.util.List<Emp> findByIsCoding(boolean isCoding);
	 ...
	 * @return the range of matching emps
	 */
	public java.util.List<Emp> findByIsCoding(
