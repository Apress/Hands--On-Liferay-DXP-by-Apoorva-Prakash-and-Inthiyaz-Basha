...
/**
 * Provides the local service interface for ApressBook. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Apoorva_Inthiyaz
 * @see ApressBookLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ApressBookLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.handsonliferay.apress_service_builder.service.impl.ApressBookLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the apress book local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ApressBookLocalServiceUtil} if injection and service tracking are not available.
	 */
