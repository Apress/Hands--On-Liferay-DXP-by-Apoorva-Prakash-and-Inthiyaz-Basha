 ...
 */
package com.handsonliferay.scheduler.config;
...
import com.handsonliferay.scheduler.constants.LiferaySchedulerExamplePortletKeys;
...
@Component(
	immediate = true,
	service = SynchronousDestinationConfig.class
)
public class SynchronousDestinationConfig {
	...
	protected void activate(BundleContext bundleContext) {
		...
		DestinationConfiguration destinationConfiguration =
			new DestinationConfiguration(
				DestinationConfiguration.DESTINATION_TYPE_SYNCHRONOUS,LiferaySchedulerExamplePortletKeys.DESTINATION_SYNCHRONOUS);
	...
	private static final Log _log = LogFactoryUtil.getLog(SynchronousDestinationConfig.class);
