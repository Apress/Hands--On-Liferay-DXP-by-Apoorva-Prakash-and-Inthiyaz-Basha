...
@Component(
	immediate = true,
	service = ParellelDestinationConfig.class
)
public class ParellelDestinationConfig {
	...
	protected void activate(BundleContext bundleContext) {
		...
		DestinationConfiguration destinationConfiguration =
			new DestinationConfiguration(
				DestinationConfiguration.DESTINATION_TYPE_PARALLEL,LiferaySchedulerExamplePortletKeys.DESTINATION_PARALLEL);
	...
	private static final Log _log = LogFactoryUtil.getLog(ParellelDestinationConfig.class);
